...
def fetch_metrics_periodically(url):
    ...
    if cpu_percent is not None and ram_percent is not None and up_time is not None and response_time is not None:
        return cpu_percent, ram_percent, up_time, response_time
    else:
        return None
